...
public class SpDeviceStorageImpl extends DefaultCrudStorage<SpDevice>
    implements ISpDeviceStorage {

  public SpDeviceStorageImpl() {
    super(
        () -> Utils.getCouchDbGsonClient("devices"),
        SpDevice.class
    );
  }
}
