...
public class AdapterAssetMappingStorageImpl
    extends DefaultCrudStorage<AdapterAssetMapping>
    implements IAdapterAssetMappingStorage {

  public AdapterAssetMappingStorageImpl() {
    super(
        () -> Utils.getCouchDbGsonClient("adapter-asset-mappings"),
        AdapterAssetMapping.class
    );
  }
}
